...
document.addEventListener("DOMContentLoaded", (event) => {
    ...
    const value1 = document.querySelector("#codeName1")
    const value2 = document.querySelector("#codeName2")
    const value3 = document.querySelector("#codeName3")
    ...
    formElement.addEventListener('submit', (event) => {
      ...
      if ('auto' === getSelectedGenerationmethod()) {
        ...
        value1.textContent = friendInput1.value;
        value2.textContent = friendInput2.value;
        value3.textContent = friendInput3.value;
